            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:gap-16 items-center">
              <div className="space-y-4">
                ...
                <p className="max-w-[600px] text-muted-foreground md:text-xl">
                  تجربه ای بی نظیر از طعم های اصیل ایرانی در فضایی دلنشین و
                  مدرن. ما بهترین ها را برای شما آماده کرده ایم.
                </p>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                منتخبی از محبوب ترین غذاها و نوشیدنی های ما که توسط سرآشپزمان
                آماده شده است.
              </p>
            </div>
            ...
            <div className="mx-auto w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 pt-8">
              <div className="flex flex-col items-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  استفاده از مواد اولیه تازه و دستور پخت های سنتی برای ارائه
                  بهترین طعم ایرانی.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  تعهد به کیفیت در تمام مراحل، از انتخاب مواد اولیه تا پخت و سرو
                  غذا.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  محیطی آرام و زیبا برای لذت بردن از غذای خود به همراه خانواده و
                  دوستان.
                </p>
              </div>
            </div>
